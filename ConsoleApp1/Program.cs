...
Console.WriteLine("Du har"); Console.WriteLine(Poäng);Console.WriteLine("Poäng");
...
Console.WriteLine("Du fick totalt"); Console.WriteLine(Poäng);Console.WriteLine("Poäng");
if (Poäng == 30)
{
...
{
   Console.WriteLine ("A du är ändå helt okej");
}
else if (Poäng == 10) 
{
Console.WriteLine("Katastrofalt");
}
else if (Poäng == 0) 
{
Console.WriteLine("Katastrofalt");
